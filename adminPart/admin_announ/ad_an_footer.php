                        ...
                        <ul class="list-unstyled clear-margins">
                            <li class="widget-container widget_nav_menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="../../productlocation/merch.php"><i class="fa fa-angle-double-right"></i>  MERCHANDISE</a></li>
                                    <li><a href="../../productlocation/custom.php"><i class="fa fa-angle-double-right"></i>  CUSTOMIZE</a></li>
