                        ...
                        <ul class="list-unstyled clear-margins">
                            <li class="widget-container widget_nav_menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="../productlocation/producview_merch.php"><i class="fa fa-angle-double-right"></i>  MERCHANDISE</a></li>
                                    <li><a href="../productlocation/producview_custom.php"><i class="fa fa-angle-double-right"></i>  CUSTOMIZE</a></li>
