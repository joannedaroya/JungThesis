                    ...
                    <!-- Main Menu -->
                       <div class="side-menu-container">
                             <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="adminView_suspend.php">View Suspends</a></li>
                                    <li><a href="adminView_blocklist.php">View Blocklists</a></li>
...
<li><a href="../admin_announ/adminAnnoun.php"><span class="glyphicon glyphicon-plane"></span> Announcement</a></li>
